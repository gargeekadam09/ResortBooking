...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i>+92844-819-15</li>	
							</div>
						</div>
					</li>
				</ul>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="#admin" class="menu__link scroll" button class="login-button"><a href="login.php">Admin Login</a></li>
</a>
						</ul>
					</nav>
				</div>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
						   ...
						   <p class="about-para-w3ls">Discover unparalleled luxury and comfort at our hotel, where impeccable service meets breathtaking views. Experience world-class amenities and cuisine in a serene oasis, providing an unforgettable escape from the everyday hustle and bustle. Whether you're here for business or leisure, our hotel is your perfect home away from home. Welcome to a haven of relaxation and sophistication</p>
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
											...
											<p>Hotel amenities are the little touches that turn a stay into an unforgettable experience. </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
			 ...
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
			 	<div class="advantage-block ">
					<i class="fa fa-credit-card" aria-hidden="true"></i>
			 		...
			 		<p>Experience the epitome of luxury in our meticulously designed hotel rooms, where modern amenities seamlessly blend with timeless sophistication.</p>
			 ...
			 <div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
			 	<div class="advantage-block">
					<i class="fa fa-clock-o" aria-hidden="true"></i>
			 		...
			 		<p>Our hotel's restaurant is a gastronomic paradise, where the art of dining is elevated to new heights, offering a symphony of delectable creations in a setting of refined elegance.</p>
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Staying at your hotel was a dream come true. From the impeccable service to the stunning views, it was a truly unforgettable experience. </p>
								<h5>Sneha Mahajan</h5>
								<p>Pune</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>I was captivated by the charm of your hotel. The attention to detail and the warm hospitality made our stay extraordinary.</p>
								<h5>Apeksha Rana</h5>
								<p>Nepal</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>What a hidden gem your hotel is! The tranquil ambiance, lush gardens, and world-class amenities created the perfect retreat from the everyday hustle and bustle. </p>
								<h5>Yash Nikam</h5>
								<p>Tamil Nadu</p>
							</div>
							<div class="clearfix"> </div>
	...
	<div class="container">
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile2" data-aos="flip-left">
			<div class="contact-agileits">
				<h4>Contact Us</h4>
				<p class="contact-agile2">Sign Up</p>
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+923000-00-00</p>
